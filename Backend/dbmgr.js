...
//Description: Demonstrates the use of database operations including creating/deleting collections and inserting, searching and updating entries.
...
const url =
  ...
  ":" +
  config.pwd +
  "@cluster0.yjzs4.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
      ...
      dbo.collection(mycollection).findOne(queryData, function (err, res) {
        ...
        if (res == null) {
          ...
          dbo
            ...
            .insertOne(queryData, function (err, res) {
              if (err) throw err;
              //insert the score of the username
              dbo
                .collection(mycollection)
                .updateOne(queryData, { $set: newData }, function (err, res) {
                  if (err) throw err;
                  db.close();
                });
            });
